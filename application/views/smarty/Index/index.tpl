...
<header>
    ...
    <div class="menu">
        <nav class="nav" id="topnav">
            ...
            <li><a href="<?php echo url::site('index/list');?>">学无止境</a>
                <ul class="sub-nav">
            ...
            <li><a href="<?php echo url::site('index/life');?>">慢生活</a>
                <ul class="sub-nav">
            ...
            <li><a href="<?php echo url::site('index/time');?>">时间轴</a> </li>
            <li><a href="<?php echo url::site('index/gbook');?>">留言</a> </li>
            <li><a href="<?php echo url::site('index/info');?>">内容页</a> </li>
            <!--search begin-->
